...
export const Chat = () => {
  ...
  const faqSuggestions = [
    language === "Tiếng Việt"
      ? "Nội dung của Nghị định 168."
      : "Contents of Decree 168.",
    language === "Tiếng Việt"
      ? "Mức xử phạt khi vượt đèn đỏ là bao nhiêu?"
    ...
    >
      <header className="p-4 border-b flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-1xl font-bold" style={{ fontSize: "2rem" }}>
            {language === "Tiếng Việt" ? "Chatbot UIT - Hỗ trợ hỏi đáp luật giao thông" : "UIT Law Chatbot"}
          </h1>
        </div>
